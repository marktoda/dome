// Lockstep marker for invariant EVERY_PROCESSOR_RUN_IS_LEDGERED.
//
// The substrate spec at docs/wiki/invariants/EVERY_PROCESSOR_RUN_IS_LEDGERED.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "EVERY_PROCESSOR_RUN_IS_LEDGERED.md");

describe("EVERY_PROCESSOR_RUN_IS_LEDGERED lockstep", () => {
