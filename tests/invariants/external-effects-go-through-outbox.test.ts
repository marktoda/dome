// Lockstep marker for invariant EXTERNAL_EFFECTS_GO_THROUGH_OUTBOX.
//
// The substrate spec at docs/wiki/invariants/EXTERNAL_EFFECTS_GO_THROUGH_OUTBOX.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "EXTERNAL_EFFECTS_GO_THROUGH_OUTBOX.md");

describe("EXTERNAL_EFFECTS_GO_THROUGH_OUTBOX lockstep", () => {
