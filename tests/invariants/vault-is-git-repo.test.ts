// Lockstep marker for invariant VAULT_IS_GIT_REPO.
//
// The substrate spec at docs/wiki/invariants/VAULT_IS_GIT_REPO.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "VAULT_IS_GIT_REPO.md");

describe("VAULT_IS_GIT_REPO lockstep", () => {
