// Lockstep marker for invariant ALL_MUTATION_GOES_THROUGH_ADOPTION.
//
// The substrate spec at docs/wiki/invariants/ALL_MUTATION_GOES_THROUGH_ADOPTION.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "ALL_MUTATION_GOES_THROUGH_ADOPTION.md");

describe("ALL_MUTATION_GOES_THROUGH_ADOPTION lockstep", () => {
