// Lockstep marker for invariant EFFECTS_ARE_THE_ONLY_PROCESSOR_OUTPUT.
//
// The substrate spec at docs/wiki/invariants/EFFECTS_ARE_THE_ONLY_PROCESSOR_OUTPUT.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "EFFECTS_ARE_THE_ONLY_PROCESSOR_OUTPUT.md");

describe("EFFECTS_ARE_THE_ONLY_PROCESSOR_OUTPUT lockstep", () => {
