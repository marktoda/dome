// Lockstep marker for invariant PROPOSALS_ARE_THE_ONLY_WRITE_PATH.
//
// The substrate spec at docs/wiki/invariants/PROPOSALS_ARE_THE_ONLY_WRITE_PATH.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "PROPOSALS_ARE_THE_ONLY_WRITE_PATH.md");

describe("PROPOSALS_ARE_THE_ONLY_WRITE_PATH lockstep", () => {
