// Lockstep marker for invariant EVERY_EFFECT_IS_CAPABILITY_CHECKED.
//
// The substrate spec at docs/wiki/invariants/EVERY_EFFECT_IS_CAPABILITY_CHECKED.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "EVERY_EFFECT_IS_CAPABILITY_CHECKED.md");

describe("EVERY_EFFECT_IS_CAPABILITY_CHECKED lockstep", () => {
