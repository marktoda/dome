// Lockstep marker for invariant INBOX_IS_EPHEMERAL.
//
// The substrate spec at docs/wiki/invariants/INBOX_IS_EPHEMERAL.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "INBOX_IS_EPHEMERAL.md");

describe("INBOX_IS_EPHEMERAL lockstep", () => {
