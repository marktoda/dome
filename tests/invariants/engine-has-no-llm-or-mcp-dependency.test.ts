// Lockstep marker for invariant ENGINE_HAS_NO_LLM_OR_MCP_DEPENDENCY.
//
// The substrate spec at docs/wiki/invariants/ENGINE_HAS_NO_LLM_OR_MCP_DEPENDENCY.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "ENGINE_HAS_NO_LLM_OR_MCP_DEPENDENCY.md");

describe("ENGINE_HAS_NO_LLM_OR_MCP_DEPENDENCY lockstep", () => {
