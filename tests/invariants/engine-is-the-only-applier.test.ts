// Lockstep marker for invariant ENGINE_IS_THE_ONLY_APPLIER.
//
// The substrate spec at docs/wiki/invariants/ENGINE_IS_THE_ONLY_APPLIER.md
...
const INVARIANT_DOC = join(REPO_ROOT, "docs", "wiki", "invariants", "ENGINE_IS_THE_ONLY_APPLIER.md");

describe("ENGINE_IS_THE_ONLY_APPLIER lockstep", () => {
