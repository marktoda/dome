...
- [[wiki/specs/mcp-surface]] — MCP server: the shipped `dome mcp` stdio adapter (wedge Phase 5) — typed capture/query/export_context/report_miss/status/check/resolve/settle/tasks/brief tools over the same handlers the CLI uses.
