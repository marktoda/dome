...
- Recent ledger entries are scannable: `dome show runs --since 24h` surfaces "the last N runs by processor and target." A user noticing weird recent activity can spot regression.
