...
**Scenario version:** `dome.product.acceptance/2026-07-11.1`
...
| P4 backup + blank-host restore checkpoint | bundled age keygen/create/verify/restore; source-drift refusal; seven SQLite snapshots; adversarial verification; absent-target reconstruction | atomic encrypted archive and atomic no-replace publication; exact manifest; no native Git dependency; restored credentials/grants invalidated; absent authority reported |
