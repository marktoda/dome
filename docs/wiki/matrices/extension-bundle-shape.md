...
| **`dome.intake`** *(first-party)* | `partially shipped` | `capture` | —; future: `preamble.md` | `extract-capture.ts`; future: `inbox-stale-check.ts`, `process-questions.ts` | — | `read: ["inbox/raw/*.md"]`; `patch.auto: ["wiki/generated/intake/*.md", "inbox/processed/*.md", "inbox/raw/*.md"]`; `model.invoke: { maxDailyCostUsd: 5 }`; future: `question.ask`, richer fact namespaces, and follow-on jobs |
