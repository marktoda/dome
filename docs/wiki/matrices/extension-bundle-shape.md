...
| **`dome.claims`** *(first-party)* | `shipped` | — | — | `claim-index.ts`, `stamp-anchor.ts`, `render-facts.ts` | — | `read: ["wiki/**/*.md", "notes/*.md"]`; `patch.auto: ["wiki/**/*.md", "notes/*.md"]`; `graph.write: ["dome.claims.*"]` |
