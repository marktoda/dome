...
| **`dome.warden`** *(first-party)* | `shipped` | — | — | `integrity.ts`, `integrity-answer.ts`, `daily-briefing.ts` | — | `read: ["wiki/**/*.md"]`; `model.invoke: { maxDailyCostUsd: 10 }`; `question.ask: true`; `patch.auto: ["wiki/generated/briefing/*.md"]` |
