...
|---|---|---|---|---|---|---|
| **`dome.markdown`** *(first-party)* | `shipped` | — | — | `validate-wikilinks.ts`, `ambiguous-wikilink-answer.ts`, `repair-wikilinks.ts`, `simplify-indexes.ts`, `normalize-frontmatter.ts`, `lint-frontmatter.ts`, `broken-images.ts`, `duplicate-detection.ts`, `duplicate-detection-answer.ts`, `stale-dates.ts`, `refresh-updated.ts`, `raw-immutable.ts`, `orphan-pages.ts` | — | `read: ["**/*.md", ".dome/page-types.yaml", images, "raw/**"]`; `patch.auto: ["**/*.md", "wiki/syntheses/*.md", "wiki/**/index.md"]`; `question.ask: true` |
