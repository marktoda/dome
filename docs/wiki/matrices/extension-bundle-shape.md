...
|---|---|---|---|---|---|---|
| **`dome.markdown`** *(first-party)* | `shipped` | — | — | `validate-wikilinks.ts`, `normalize-frontmatter.ts`, `lint-frontmatter.ts`, `broken-images.ts`, `duplicate-detection.ts`, `stale-dates.ts`, `raw-immutable.ts`, `orphan-pages.ts` | — | `read: ["**/*.md", ".dome/page-types.yaml", images, "raw/**"]`; `patch.auto: ["**/*.md"]`; `question.ask: true` |
