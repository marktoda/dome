...
| `dome.intake` | "talk about my day" capture compilation | raw capture extraction plus low-confidence question/answer handling shipped for `inbox/raw/*.md`; stale-inbox checks and richer synthesis remain |
