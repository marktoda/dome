...
|---|---|---|
| `dome.markdown` | adoption: validate-wikilinks, normalize-frontmatter, lint-frontmatter, broken-images, duplicate-detection; view: orphan-pages | Keeps markdown pages well-formed; emits diagnostics on broken references/frontmatter issues, asks about suspected duplicates, and provides the orphan-pages view. |
