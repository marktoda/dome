...
|---|---|---|
| `dome.markdown` | adoption: validate-wikilinks, normalize-frontmatter, lint-frontmatter, broken-images, duplicate-detection, stale-dates; view: orphan-pages | Keeps markdown pages well-formed; normalizes frontmatter, refreshes managed `updated:` dates during adoption, emits diagnostics on broken references/frontmatter and informational diagnostics for remaining adopted-date drift, asks about high-confidence duplicate canonical content pages, and provides the orphan-pages view. |
