...
groups include both `first_source_refs` (compact file/line display text for the
repair loop) and `firstSourceRefs` (structured SourceRef objects, including
...
newest-row insertion order. Abbreviated example:
