...
| `dome.intake` | garden: extract-capture | Compiles `inbox/raw/*.md` captures into generated capture pages plus processed archives; generated markdown feeds the daily task/followup index. |
