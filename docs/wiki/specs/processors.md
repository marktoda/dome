...
| `dome.search` | adoption: index-text; view: query, export-context | Maintains the FTS5 projection; answers adopted-state query and context-packet requests with read-first overviews, open loops, decisions, questions, diagnostics, and source-backed match detail. |
