...
describe("api types", () => {
  test("shapes accept representative server payloads", () => {
    ...
    const recents: Recents = { schema: "dome.recents/v1", count: 1, entries: [{ path: "wiki/x.md", title: "X", lastChangedAt: "2026-06-17T00:00:00Z", changedBy: "human", subject: "edit", commit: "a".repeat(40) }] };
