 ...
 */
export function createRateLimitMiddleware(windowMs = 60000, maxRequests = 100, keyGenerator = c => c.req.header('x-forwarded-for') || c.req.header('cf-connecting-ip') || 'unknown') {
