 ...
 */
export declare function errorHandler(options?: ErrorHandlerOptions): (c: Context, next: Next) => Promise<(Response & import("hono").TypedResponse<never>) | undefined>;
/**
 ...
 * @returns A DomeError instance
 */
export declare function toDomeError(error: unknown, defaultMessage?: string, defaultDetails?: Record<string, any>): DomeError;
/**
 ...
 */
export declare function createErrorWrapper(defaultMessage: string, defaultDetails?: Record<string, any>): <T>(fn: () => Promise<T>, message?: string, details?: Record<string, any>) => Promise<T>;
/**
 ...
 */
export declare function assertValid(condition: boolean, message: string, details?: Record<string, any>): void;
/**
 ...
 */
export declare function assertExists<T>(value: T | null | undefined, message: string, details?: Record<string, any>): T;
/**
 ...
 */
export declare function handleDatabaseError(error: unknown, operation: string, details?: Record<string, any>): DomeError;
/**
 ...
 */
export declare function createErrorFactory(domain: string, defaultDetails?: Record<string, any>): {
    ...
    unauthorized: (message: string, details?: Record<string, any>, cause?: Error) => UnauthorizedError;
    ...
    serviceUnavailable: (message: string, details?: Record<string, any>, cause?: Error) => ServiceUnavailableError;
    ...
    assertExists: <T>(value: T | null | undefined, message: string, details?: Record<string, any>) => T;
    handleDatabaseError: (error: unknown, operation: string, details?: Record<string, any>) => DomeError;
};
