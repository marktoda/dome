...
export function createErrorFactory(domain, defaultDetails = {}) {
  return {
    validation: (message, details, cause) =>
    ...
    internal: (message, details, cause) =>
    ...
    rateLimit: (message, details, cause) =>
