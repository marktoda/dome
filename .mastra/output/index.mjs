...
import { writeNoteTool, getNoteTool, listNotesTool } from './tools/54fae4bf-31ec-4778-9f26-180e4773a86c.mjs';
...
const notesAgent = new Agent({
  ...
  instructions: `
      ...
      - YAML front-matter with metadata like title, date, tags, id, source
      - Markdown content with headings, lists, etc.
      - Any filename structure (though CLI-generated notes follow YYYY-MM-DD-slug.md pattern)
      ...
      - For writing notes, use 'auto' mode by default to intelligently create or append
      ...
      Use the listNotesTool to list notes, getNoteTool to retrieve specific notes, and writeNoteTool to create new notes or append to existing ones.
`,
