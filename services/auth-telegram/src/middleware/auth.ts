 ...
 */
export function apiKeyAuth(apiKey: string | ((c: Context<{ Bindings: Bindings; Variables?: any }>) => string)) {
 ...
 */
export function adminAuth(adminApiKey: string | ((c: Context<{ Bindings: Bindings; Variables?: any }>) => string)) {
  return async (c: Context<{ Bindings: Bindings; Variables?: any }>, next: Next) => {
    const authHeader = c.req.header('Authorization');
