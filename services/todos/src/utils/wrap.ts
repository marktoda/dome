...
/**
 * Service-specific wrapper for the Todos service
 * This uses the standardized function wrapper with Todos-specific context
 */
const wrapServiceFunction = createServiceWrapper('todos');

/**
 * Wraps a function call with logging context specific to the Todos service.
