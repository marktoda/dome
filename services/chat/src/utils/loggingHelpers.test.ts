...
describe('loggingHelpers', () => {
  describe('createStateSummary', () => {
    ...
    it('should truncate long messages', () => {
      const longContent =
        'This is a very long message that should be truncated in the logging summary. We want to make sure that it does not take up too much space in the logs.';
      ...
      const summary = createStateSummary(state);
      expect(summary.messages[0].content).toEqual(
