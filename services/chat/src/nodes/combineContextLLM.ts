...
import { AgentState, Document, ToolResult, SourceMetadata } from "../types";
 ...
 */
export async function combineContextLLM(
  state: AgentState,
  env: Env,
...
Label sources explicitly to maintain clear attribution.
