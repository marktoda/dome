  ...
  return [
    ...
    [
      { role: 'user', content: 'What is machine learning?' },
      {
        role: 'assistant',
        content:
          'Machine learning is a subset of artificial intelligence that focuses on building systems that learn from data. Instead of being explicitly programmed to perform a task, these systems are trained on large datasets and learn to recognize patterns and make decisions with minimal human intervention.',
      },
    ...
    [
      { role: 'user', content: 'How do I bake a chocolate cake?' },
      {
        role: 'assistant',
        content:
          "To bake a chocolate cake, you'll need ingredients like flour, sugar, cocoa powder, eggs, milk, and butter. Preheat your oven to 350°F (175°C), mix the dry ingredients, add the wet ingredients, pour into a greased pan, and bake for about 30-35 minutes.",
      },
      { role: 'user', content: 'What about frosting?' },
      {
        role: 'assistant',
        content:
          'For chocolate frosting, you can mix softened butter with powdered sugar, cocoa powder, vanilla extract, and a little milk until smooth and creamy. Wait for the cake to cool completely before frosting it.',
      },
