...
async function main() {
  try {
    ...
    if (result.reprocessed && 'id' in result.reprocessed) {
      console.log(`Reprocessed content ID: ${result.reprocessed.id}, Success: ${result.reprocessed.success}`);
    } else if (result.reprocessed && 'total' in result.reprocessed && 'successful' in result.reprocessed) {
      console.log(`Reprocessed ${result.reprocessed.total} items, ${result.reprocessed.successful} successful`);
    } else {
