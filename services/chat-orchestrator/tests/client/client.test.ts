...
import { ChatOrchestratorClient, ChatOrchestratorRequest } from '../../src/client/client';
...
describe('ChatOrchestratorClient', () => {
  let client: ChatOrchestratorClient;
  ...
  beforeEach(() => {
    ...
    // Create client
    client = new ChatOrchestratorClient(mockBinding);
  });
  ...
  describe('generateResponse', () => {
    it('should generate a chat response', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.generate_response.success', 1);
      expect(metrics.timing).toHaveBeenCalledWith('chat_orchestrator.client.generate_response.duration_ms', 100);
    });
    ...
    it('should handle errors when generating a response', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.generate_response.errors', 1, {
        errorType: 'Error'
      });
    });
  ...
  describe('streamResponse', () => {
    it('should stream a chat response', async () => {
      ...
      expect(mockBinding.generateChatResponse).toHaveBeenCalledWith(request);
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.stream_response.success', 1);
    });
    ...
    it('should handle errors when streaming a response', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.stream_response.errors', 1, {
        errorType: 'Error'
      });
    });
  });
  ...
  describe('resumeChatSession', () => {
    it('should resume a chat session', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.resume_chat.success', 1);
    });
    ...
    it('should handle errors when resuming a chat session', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.resume_chat.errors', 1, {
        errorType: 'Error'
      });
    });
  });
  ...
  describe('admin operations', () => {
    it('should get checkpoint stats', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.get_checkpoint_stats.success', 1);
    });
    ...
    it('should clean up checkpoints', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.cleanup_checkpoints.success', 1);
    });
    ...
    it('should delete user data', async () => {
      ...
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.delete_user_data.success', 1);
    });
    ...
    it('should record user consent', async () => {
      ...
      expect(mockBinding.recordConsent).toHaveBeenCalledWith('test-user', 'chatHistory', { durationDays: 30 });
      expect(metrics.increment).toHaveBeenCalledWith('chat_orchestrator.client.record_consent.success', 1);
    });
  });
});