  ...
  describe('Edge Cases', () => {
    ...
    it('should handle concurrent identical requests', async () => {
      ...
      const requests = Array(5)
        .fill(null)
        .map(() => contentController.simplePut(requestData));
  ...
  describe('Performance Tests', () => {
    ...
    it('should handle large metadata efficiently', async () => {
      ...
      const largeMetadata = {
        ...
        description:
          'A very long description that contains lots of information about this test document',
        tags: Array(100)
          .fill(null)
          .map((_, i) => `tag-${i}`),
