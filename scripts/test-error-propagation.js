...
async function runTest(scenario) {
  ...
  try {
    ...
    console.log(`Status Code: ${response.status} (expected: ${scenario.expectedStatus}) - ${statusMatch ? '✅' : '❌'}`);
    ...
    console.log(`Error structure validation: ${hasErrorObject && hasErrorCode && hasErrorMessage ? '✅' : '❌'}`);
    
    // Verify error details
    const hasRequestIdInDetails = hasErrorObject && 
    ...
    const serviceContextEnriched = hasErrorObject && 
                                 responseData.error.details && 
                                 responseData.error.details.service;
