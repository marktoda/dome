...
# grants. The shipped first-party bundles (\`dome.graph\`, \`dome.health\`,
# \`dome.lint\`, \`dome.markdown\`, \`dome.search\`) live with the SDK — the
...
The first-party extension bundles (dome.graph, dome.health, dome.lint,
dome.markdown, dome.search) live with the SDK at <SDK>/assets/extensions/ and
