// engine/host/compiler-host: runtime host operations over an open VaultRuntime.
//
...
//
// House-style notes (matches src/engine/host/vault-runtime.ts):
...
import { compileRange } from "../core/compile-range";
import {
  rebuildProjection,
...
} from "../operational/operational-work";
import {
  runAnswerHandlers,
